 ...
 * @return string
 */
function _e2($id, $parameters = array(), $locale = null)
{
 ...
 * @return bool
 */
function is_serialized2( $data, $strict = true ) 
{
 ...
 * @return mixed
 */
function maybe_unserialize2($original) 
{
 ...
 * @return mixed
 */
function maybe_serialize2($data) 
{
	if (is_array($data) || is_object($data)) {
 ...
 */
function _make_url_clickable_cb2($matches)
{
	$url = $matches[2];
 ...
 * Helper for @make_clickable();
 */
function _make_web_ftp_clickable_cb2($matches)
{
	$ret = '';
	$dest = $matches[2];
	$dest = 'http://' . $dest;
 ...
 * Helper for @make_clickable();
 */
function _make_email_clickable_cb2($matches)
{
 ...
 * Helper for @make_clickable();
 */
function _split_str_by_whitespace2($string, $goal)
{
	$chunks    = array();
 ...
 * @return string
 */
function convert_smilies2($text)
{
