...
<section class="module login">
    ...
    <form class="multi-page-form"  id="form10-3"  method="post" action="p.php" >
      ...
      <div class="multi-page-form-content">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-block border">
              <p>Is this your home or an investment?</p>
              <label class="radio-inline">
                <input type="radio" name="propcategory" id="propdet1" value="1"> My home
              </label>
              <label class="radio-inline">
                <input type="radio" name="propcategory" id="propdet2" value="2"> An investment
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-block border">
              ...
              <select id="proptype" name="proptype" class="border">
                <option></option>
				  <?php 
          ...
          <div class="col-md-6">
            <div class="form-block border">
              ...
              <select id="propbedrooms" name="propbedrooms"  class="border">
                <option></option>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-block border">
              ...
              <select id="propbathrooms" name="propbathrooms" class="border">
                <option></option>
                <option selected="" value="10">1</option>
          ...
          <div class="col-md-6">
            <div class="form-block border">
              ...
              <select id="propparking" name="propparking"  class="border">
                <option></option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
		...
		<a class="btn-progress-back link-icon va-container va-container-v pull-left text-gray link--accessibility-outline botback" href="submit-property-step2.php"><span class="iconback hide-sm"></span><span class="va-middle textbotback"><h5 class="text-normal"><span>Back</span></h5></span></a>
		  
		  <button type="submit" form="form10-3" class="button button-icon right form-next nextbtn"><i class="fa fa-angle-right"></i> Next</button>
